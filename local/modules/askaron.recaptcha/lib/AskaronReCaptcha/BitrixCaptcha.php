...
class BitrixCaptcha
{
    ...
    public function initJS()
    {
        ...
        $Asset->addString('<script src="/bitrix/js/askaron.recaptcha/script.js"></script>');
    ...
    public function initCheckSpam()
    {
        ...
        $EventManager->addEventHandler('form', 'onBeforeResultAdd', ['askaronReCaptcha\BitrixCaptcha', 'checkWebForm']);
        $EventManager->addEventHandler('main', 'OnBeforeUserRegister', ['askaronReCaptcha\BitrixCaptcha', 'checkRegistration']);
        $EventManager->addEventHandler('main', 'OnBeforeEventAdd', ['askaronReCaptcha\BitrixCaptcha', 'checkFeedback']);
        $EventManager->addEventHandler('iblock', 'OnBeforeIBlockElementAdd', ['askaronReCaptcha\BitrixCaptcha', 'checkIBlock']);
        $EventManager->addEventHandler('sale', 'OnBeforeOrderAdd', ['askaronReCaptcha\BitrixCaptcha', 'checkSaleOrder']);
    }
